...
A small sample Gradle project that ties together the two deliverables of the Adyen coding assignment. The actual implementations live in their own repositories, and this repo simply shows them being used.
